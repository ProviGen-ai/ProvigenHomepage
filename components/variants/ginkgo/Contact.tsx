            ...
            >
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3.5 bg-white/[0.07] border border-white/10 rounded-xl text-white placeholder-white/45 focus:outline-none focus:border-logo-blue/50 focus:ring-1 focus:ring-logo-blue/30 transition-all"
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3.5 bg-white/[0.07] border border-white/10 rounded-xl text-white placeholder-white/45 focus:outline-none focus:border-logo-blue/50 focus:ring-1 focus:ring-logo-blue/30 transition-all resize-none"
