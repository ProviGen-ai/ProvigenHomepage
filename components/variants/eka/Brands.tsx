  ...
  return (
    <div className="flex items-center justify-center w-full h-24">
      <a
        ...
        className={`relative ${logoHeight} w-auto max-w-[200px] transition-all duration-300 hover:scale-105 flex items-center justify-center gap-1 opacity-40 hover:opacity-100 grayscale hover:grayscale-0`}
        style={
          backgroundHex
